...
export default function UserReports() {
  ...
  const [sortBy, setSortBy] = useState<
    "symbol" | "return" | "volatility" | "allocation"
  >("symbol");
        ...
        <TabsContent value="daily" className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <HelpTip
                content="Daily performance overview with key metrics and charts."
                side="right"
              />
            </div>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <HelpTip
                        content="Total return, performance, active portfolios, and average performance."
                        side="left"
                      />
                    </div>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <HelpTip
                        content="Volatility, Sharpe ratio, and maximum drawdown."
                        side="left"
                      />
                    </div>
                  </CardHeader>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {dailyReport.riskMetrics.volatility.toFixed(2)}%
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <HelpTip
                        content="Best and worst assets for the selected period."
                        side="left"
                      />
                    </div>
                  </CardHeader>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium">
                            Best: {dailyReport.topPerformer.asset}
                          </span>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium">
                            Worst: {dailyReport.bottomPerformer.asset}
                          </span>
                        </div>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <HelpTip
                      content="Compare strategy returns against benchmark over time."
                      side="left"
                    />
                  </div>
                </CardHeader>
        ...
        <TabsContent value="weekly" className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <HelpTip
                content="Weekly summary, asset performance, and detailed table."
                side="right"
              />
            </div>
            <div className="flex space-x-2">
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <HelpTip
                      content="Key weekly KPIs like return, win rate, and trades."
                      side="left"
                    />
                  </div>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <HelpTip
                      content="Bar chart of per-asset weekly returns."
                      side="left"
                    />
                  </div>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <HelpTip
                      content="Complementary measures that relate returns to risk taken."
                      side="left"
                    />
                  </div>
                </CardHeader>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground flex items-center gap-1">
                        Information Ratio{" "}
                        <HelpTip
                          content="Excess return vs benchmark per unit of tracking error (std. dev. of active returns)."
                          side="top"
                        />
                      </p>
                      <p className="text-2xl font-bold">
                    ...
                    <div>
                      <p className="text-sm font-medium text-muted-foreground flex items-center gap-1">
                        Calmar Ratio{" "}
                        <HelpTip
                          content="Return divided by maximum drawdown; higher = better drawdown-adjusted returns."
                          side="top"
                        />
                      </p>
                      <p className="text-2xl font-bold">
                        {weeklyReport.performanceMetrics.calmarRatio.toFixed(2)}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground flex items-center gap-1">
                        Sortino Ratio{" "}
                        <HelpTip
                          content="Like Sharpe but only penalizes downside volatility (bad volatility)."
                          side="top"
                        />
                      </p>
                      <p className="text-2xl font-bold">
              ...
              <Card className="lg:col-span-2">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <HelpTip
                      content="Tabular per-asset metrics for deeper analysis."
                      side="left"
                    />
                  </div>
                </CardHeader>
        ...
        <TabsContent value="per-asset" className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <HelpTip
                content="Analyze each asset's allocations, returns, and risk."
                side="right"
              />
            </div>
            <div className="flex space-x-2">
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <HelpTip
                      content="Search and sort the assets table to focus your analysis."
                      side="left"
                    />
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <HelpTip
                        content="Filter assets by symbol or name."
                        side="right"
                      />
                    </div>
                    <div className="flex items-center space-x-2">
                      <Label>Sort by:</Label>
                      <HelpTip
                        content="Choose the attribute to sort assets."
                        side="right"
                      />
                      <select
                        value={sortBy}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <HelpTip
                        content="Toggle ascending/descending sort order."
                        side="right"
                      />
                    </div>
                  </div>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <HelpTip
                        content="Distribution of capital across assets."
                        side="left"
                      />
                    </div>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <HelpTip
                        content="Scatter of returns against volatility to assess risk-adjusted performance."
                        side="left"
                      />
                    </div>
                  </CardHeader>
                ...
                <CardHeader>
                  <div className="flex items-start justify-between w-full">
                    <div>
                      ...
                      <CardDescription>
                        {filteredAndSortedAssets.length} of{" "}
                        {perAssetReport.assets.length} assets shown
                      </CardDescription>
                    </div>
                    <HelpTip
                      content="Full per-asset table with prices, returns, and risk metrics."
                      side="left"
                    />
                  </div>
                </CardHeader>
                      ...
                      <TableRow>
                        ...
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Current Price{" "}
                            <HelpTip
                              content="Latest traded price for the asset."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Daily Change{" "}
                            <HelpTip
                              content="Price change since yesterday (percent)."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Weekly Change{" "}
                            <HelpTip
                              content="Price change over the past week (percent)."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Monthly Return{" "}
                            <HelpTip
                              content="Return percent over the past month."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Total Return{" "}
                            <HelpTip
                              content="Cumulative profit/loss in currency."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Allocation{" "}
                            <HelpTip
                              content="Percentage of portfolio invested in the asset."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Volatility{" "}
                            <HelpTip
                              content="Return variability; higher means more risk."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Sharpe{" "}
                            <HelpTip
                              content="Risk-adjusted return: (return − risk‑free) ÷ volatility. Higher is better."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Trades{" "}
                            <HelpTip
                              content="Trade count used for the metrics."
                              side="top"
                            />
                          </div>
                        </TableHead>
                        <TableHead>
                          <div className="flex items-center gap-1">
                            Avg Hold{" "}
                            <HelpTip
                              content="Average time positions were held (hours)."
                              side="top"
                            />
                          </div>
                        </TableHead>
        ...
        <TabsContent value="backtest" className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <HelpTip
                content="Download the latest backtest CSV and review recent activity."
                side="right"
              />
            </div>
          </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-start justify-between w-full">
                <div>
                  ...
                  <CardDescription>
                    Download the most recent backtest analysis results as a CSV
                    file
                  </CardDescription>
                </div>
                <HelpTip
                  content="Generates and downloads the latest backtest as CSV."
                  side="left"
                />
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <Alert>
                ...
                <AlertDescription>
                  The backtest report includes strategy performance, risk
                  metrics, trade analysis, and comparison with benchmarks over
            ...
            <CardHeader>
              <div className="flex items-start justify-between w-full">
                <div>
                  ...
                  <CardDescription>
                    Latest report downloads and generation history
                  </CardDescription>
                </div>
                <HelpTip
                  content="Log of recent exports and generation events."
                  side="left"
                />
              </div>
            </CardHeader>
